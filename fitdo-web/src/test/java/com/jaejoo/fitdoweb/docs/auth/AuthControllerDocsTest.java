...
class AuthControllerDocsTest extends RestDocsSupport {
    ...
    void loginNewUser() throws Exception {
        // given
        LoginRequest loginRequest = LoginRequest.builder().loginType("KAKAO").build();
