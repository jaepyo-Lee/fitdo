package com.jaejoo.fitdobatch.batch.job;

import com.jaejoo.fitdobatch.batch.mapping.rowmapper.UserScoreMapper;
import com.jaejoo.fitdobatch.batch.item.RedisSortedSetItemWriter;
import com.jaejoo.fitdobatch.batch.mapping.BodyPart;
import com.jaejoo.fitdobatch.batch.mapping.CalculateScoreRow;
import com.jaejoo.fitdobatch.batch.mapping.UserScoreRow;
import com.jaejoo.fitdobatch.batch.mapping.rowmapper.CalculateScoreRowMapper;
...
public class ScoreJobConfiguration {
    ...
    @Bean
    public Job run(JobRepository jobRepository, PlatformTransactionManager transactionManager) throws Exception {
